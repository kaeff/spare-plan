  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved resource as @resource" do
        ...
        post :create, {:resource => { "name" => "invalid value" }}, valid_session
        assigns(:resource).should be_a_new(Resource)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested resource" do
        ...
        Resource.any_instance.should_receive(:update_attributes).with({ "name" => "MyString" })
        put :update, {:id => resource.to_param, :resource => { "name" => "MyString" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the resource as @resource" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Resource.any_instance.stub(:save).and_return(false)
        put :update, {:id => resource.to_param, :resource => { "name" => "invalid value" }}, valid_session
        assigns(:resource).should eq(resource)
      end
